...
<!-- Two columns -->
	<div class="row">
		...
		<div class="col-md-8">
			<!-- Carousel-->
			<div class="carousel slide" id="carousel-247961">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-247961">
					</li>
					<li data-slide-to="1" data-target="#carousel-247961">
					</li>
					<li data-slide-to="2" data-target="#carousel-247961">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="item active">
						<img alt="" src="http://64.19.142.11/lorempixel.com/1600/500/sports/1">
					...
					<div class="item">
						<img alt="" src="http://64.19.142.13/lorempixel.com/1600/500/sports/2">
						<div class="carousel-caption">
							<h4>
					...
					<div class="item">
						<img alt="" src="http://64.19.142.11/lorempixel.com/1600/500/sports/3">
						<div class="carousel-caption">
							<h4>
			...
			<div class="panel panel-default">
			  <div class="panel-body">
				<form class="form-horizontal" role="form">
				  <div class="form-group">
					<label for="inputEmail1" class="control-label input-sm col-lg-3">Email</label>
					<div class="col-lg-9">
					  <input type="email" class="form-control input-sm" id="inputEmail1" placeholder="Email">
					</div>
				  </div>
				  <div class="form-group">
					<label for="inputPassword1" class="control-label input-sm col-lg-3">Password</label>
					<div class="col-lg-9">
				  ...
				  <div class="form-group">
					<div class="col-lg-offset-3 col-lg-9">
					  <div class="checkbox">
						<label>
						  <small><input type="checkbox"> Remember me</small>
						</label>
					  </div>
					</div>
				  </div>
